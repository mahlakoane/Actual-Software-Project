...
public:
    ...
    const static constexpr float MOVING_OBJECT_WIDTH = 34.0f;
    const static constexpr float MOVING_OBJECT_HEIGHT = 34.0f;
    ...
    const static constexpr float MOVING_OBJECT_X_ORIGIN = MOVING_OBJECT_WIDTH / 2; //17
    const static constexpr float MOVING_OBJECT_Y_ORIGIN = MOVING_OBJECT_WIDTH / 2; //17
    ...
    const static constexpr auto INKY_START_XPOS = SCREEN_WIDTH / 2 - 40;
    const static constexpr auto INKY_START_YPOS = SCREEN_HEIGHT / 2 - 58;

    const static constexpr auto PINKY_START_XPOS = SCREEN_WIDTH / 2 + 40;
    ...
    const static constexpr auto CLYDE_START_YPOS = SCREEN_HEIGHT / 2 - 58;

    const static constexpr auto BLINKY_START_XPOS = SCREEN_WIDTH / 2;
    const static constexpr auto BLINKY_START_YPOS = SCREEN_HEIGHT / 2 - 130;
